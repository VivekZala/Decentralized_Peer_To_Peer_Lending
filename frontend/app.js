  ...
  loadLenders : async () => {
    ...
    all_potential_lenders.forEach(async lender => {
      ...
      if(borrower == App.account){
        ...
        <td data-label="">
        <a href="#"><button id=${lender.loanId} class="btn btn__primary p" onClick=App.getLoan()>Get Loan</button></a>
        </td>
        <td data-label="">
        <a href="#"><button id=${lender.loanId} onClick= App.repay(${lender.loanId}) class="btn btn__secondary r")>Repay</button></a>
        </td>
